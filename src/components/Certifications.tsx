...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-24 bg-transparent relative z-10 overflow-hidden">
      ...
      <div className="absolute top-[20%] left-[-10%] w-[350px] h-[350px] md:w-[500px] md:h-[500px] bg-cyan-500/10 dark:bg-cyan-600/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[350px] h-[350px] md:w-[500px] md:h-[500px] bg-blue-500/10 dark:bg-blue-600/5 rounded-full blur-[100px] pointer-events-none" />
