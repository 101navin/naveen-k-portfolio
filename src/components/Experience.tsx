...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-24 bg-transparent relative z-10 overflow-hidden">
      ...
      <div className="absolute top-[20%] right-[-10%] w-[350px] h-[350px] md:w-[500px] md:h-[500px] bg-purple-500/10 dark:bg-purple-600/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[20%] left-[-10%] w-[350px] h-[350px] md:w-[500px] md:h-[500px] bg-indigo-500/10 dark:bg-indigo-600/5 rounded-full blur-[100px] pointer-events-none" />
